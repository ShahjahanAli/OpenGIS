...
public class JMapViewer extends JPanel implements TileLoaderListener {
    ...
    public JMapViewer(TileCache tileCache, int downloadThreadCount) {
        ...
        setDisplayPositionByLatLon(25, 100, 3);
        //setToolTipText("");
    }
    ...
    protected void initializeZoomSlider() {
        ...
        zoomSlider.setBounds(466, 650, 150, 30);
        ...
        zoomInButton.setBounds(448, 650, size, size);
        ...
        zoomOutButton.setBounds(616, 650, size, size);
                ...
                for (int j = 0; j < x; j++) {
                    if (x_min <= posx && posx <= x_max && y_min <= posy && posy <= y_max) {
                        ...
                        if (tile != null) {
                            ...
                            String MGRS = OpenGIS_MAIN.MGRS;
                            if (tileGridVisible) {

                                g.drawRect(posx, posy, tilesize, tilesize);
//                                g.drawString(MGRS, posx, posy - 15);
//
//                                g.drawString(" " , posx + 15, posy);
//                                g.drawString(" Hi" , posx, posy - 15);
//                                System.out.println(" Grip Point: " + posx + " " + posy);
//                                System.out.println(" Tile Size: " + tilesize + " " + tilesize);

//                                g.drawString(" Bi", posx + 15, posy);
//                                g.drawString(" Hi", posx, posy - 15);
//                                System.out.println(" Grip Point: " + posx + " " + posy);
//                                System.out.println(" Tile Size: " + tilesize + " " + tilesize);
                            }

//                            System.out.println("GR: " + posx + " " + posy);
                        }
                    }
                    Point p = move[iMove];
                    posx += p.x * tilesize;
    ...
    public void unsetTileGridVisible(boolean tileGridVisible) {
        this.tileGridVisible = tileGridVisible;
        repaint();
    }
...
* ()
    ...
    public double getOnePixEquivalentNM() {
        int tilesize = tileSource.getTileSize();
        int mapSize = tilesize << zoom;
        return mapSize / (float) (60 * 360);
    }
}
